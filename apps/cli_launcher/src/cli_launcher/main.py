...
class CliLauncher:
    ...
    def __init__(self):
        self.monorepo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..'))
    ...
    def _get_command(self, app):
        ...
        return f"source \"{activate_script}\" && pip install -r requirements.txt && {app['run_command']}"
